...
> [!IMPORTANT]
> você pode considerar que n sempre é maior ou igual a 1 e menor ou igual ao número de elementos da sequência.

## Saída
Seu programa deve imprimir de forma decrescente o n maiores elementos da sequência lida.
